...
int main()
{
    ...
    do
    {
        ...
        if(a<b && b<c) //abc
        {
            printf("\n\nMenor a mayor: %i, %i, %i",a,b,c);
        }
        else if(a<c && c<b) //acb
        {
            printf("\n\nMenor a mayor: %i, %i, %i",a,c,b);
        }
        else if(b<a && a<c) //bac
        {
            printf("\n\nMenor a mayor: %i, %i, %i",b,a,c);
        }
        else if(b<c && c<a) //bca
        {
            printf("\n\nMenor a mayor: %i, %i, %i",b,c,a);
        }
        else if(c<a && a<b) //cab
        {
            printf("\n\nMenor a mayor: %i, %i, %i",c,a,b);
        }
        else if(c<b && b<a) //cba
        {
            printf("\n\nMenor a mayor: %i, %i, %i",c,b,a);
        }
