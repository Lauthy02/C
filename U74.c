...
//------------------------CON A---------------------------------------------------------
        ...
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",a,c,b,d);
        }
        else if(a>c && c>d && d>b) //acdb
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",a,c,d,b);
        }
        else if(a>d && d>c && c>b) //adcb
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",a,d,c,b);
        }
        else if(a>b && d>b && b>c) //adbc
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",a,d,b,c);
        }
//------------------------CON B---------------------------------------------------------
        else if(b>a && a>c && c>d) //bacd
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,a,c,d);
        }
        else if(b>a && a>d && d>c) //badc
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,a,d,c);
        }
        else if(b>c && c>d && d>a) //bcda
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,c,d,a);
        }
        else if(b>c && c>a && a>d) //bcad
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,c,a,d);
        }
        else if(b>d && d>c && c>a) //bdca
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,d,c,a);
        }
        else if(b>d && d>a && a>c) //bdac
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",b,d,a,c);
        }
//------------------------CON C---------------------------------------------------------
        else if(c>d && d>a && a>b) //cdab
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,d,a,b);
        }
        else if(c>d && d>b && b>a) //cdba
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,d,b,a);
        }
        else if(c>a && a>b && b>d) //cabd
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,a,b,d);
        }
        else if(c>a && a>d && d>b) //cadb
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,a,d,b);
        }
        else if(c>b && b>a && a>d) //cbad
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,b,a,d);
        }
        else if(c>b && b>d && d>a) //cbda
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",c,b,d,a);
        }
//------------------------CON D---------------------------------------------------------
        else if(d>a && d>a && a>b) //dabc
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,a,d,c);
        }
        else if(d>a && d>b && b>a) //dacb
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,a,c,d);
        }
        else if(d>b && a>b && b>d) //dbac
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,b,a,c);
        }
        else if(d>b && a>d && d>b) //dbca
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,b,c,a);
        }
        else if(d>c && b>a && a>d) //dcba
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,c,b,a);
        }
        else if(d>c && b>d && d>a) //dcab
        {
            printf("\n\nMayor a menor: %i, %i, %i, %i",d,c,a,b);
        }
